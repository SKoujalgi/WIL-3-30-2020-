    ...
    <section class="events FullWidth">
        <div class="eventHeader">
            <span class= "eventName">
                <h4>List of all Upcoming events in BOSTON!!</h4>
    </section>
  </div>

  <!-- This For-loop is for printing all the events in Boston Chapter ----->
  <div>
    <section class="events FullWidth">
        <div class="eventHeader">
        <?php
...
$q = "SELECT * FROM Events where event_belong_to_chapter= 'Boston' ";
...
if (mysqli_num_rows($r)>0) {
    ...
    while($row = mysqli_fetch_assoc($r)){
		...
		<tr>
            ...
            <td><a href="details.php?event_name="+ Boston>click here</a></td>
